...
// Assets
// import Logo from "@/public/assets/img/SeaskyLogo.jpg";
// import Logo from "@/public/assets/img/cargo.jpg";
    ...
    <InvoiceLayout data={data}>
      ...
      <div className="flex justify-between">
        ...
        <div className="text-right">
          ...
          {/* <span className="mt-1 block font-bold">{details.invoiceNumber}</span> */}
        ...
        <div className="sm:text-right space-y-2">
          <div className="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
            ...
            <dl className="grid sm:grid-cols-6 gap-x-3">
              ...
              <dd className="col-span-3 text-gray-500">{details.mawb}</dd>
            </dl>
            <dl className="grid sm:grid-cols-6 gap-x-3">
              <dt className="col-span-3 font-semibold text-gray-800">
                HAWB #:
              </dt>
              <dd className="col-span-3 text-gray-500">{details.hawb}</dd>
            </dl>
            <dl className="grid sm:grid-cols-6 gap-x-3">
              <dt className="col-span-3 font-semibold text-gray-800">
                Number of Pieces:
              </dt>
              <dd className="col-span-3 text-gray-500">{details.noofpcs}</dd>
            </dl>
            <dl className="grid sm:grid-cols-6 gap-x-3">
              <dt className="col-span-3 font-semibold text-gray-800">
                Gross Weight:
      ...
      <div className="mt-3">
        <div className="border border-gray-300 p-1 rounded-lg space-y-1">
          ...
          <div className="hidden sm:block border-b border-gray-300"></div>
          <div className="grid grid-cols-4 sm:grid-cols-6 gap-y-1">
